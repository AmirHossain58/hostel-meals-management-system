...
const AllReviews = () => {
  ...
  const {
    ...
    queryKey: ["all-reviews", currentPage, itemsPerPage],
    queryFn: async () => {
      const { data } = await axiosSecure.get(
        `/reviews?page=${currentPage}&size=${itemsPerPage}`
      );
      return data;
    },
  });
  useEffect(() => {
    const getCount = async () => {
      const { data } = await axiosSecure(`/reviews-count`);
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 sm:px-8">
        ...
        <div className="min-h-[calc(100vh-200px)]  -mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
